...
<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">GoupPertama</a>
</h4>
</div>
...
<div class="panel-body">
  ...
  <div class="table-responsive">
                  ...
                  <?php
$query = mysql_query("SELECT * FROM data_pasien WHERE id='$_GET[id]'");
...
?>
    ...
    <tr>
       <td><label for="id">Kode Pasien</label></td>
        <td><input name="id" type="text" class="form-control" value="<?php echo $data['id'];?>" readonly="readonly"/></td>
      </tr>
      
      <tr>
        <td><label for="nama_pasien">Nama Pasien</label></td>
        <td><input name="nama_pasien" type="text" class="form-control"  value="<?php echo $data['nama_pasien'];?>" required/></td>
      </tr>
     <tr>
        <td><label for="jk">Jenis Kelamin</label></td>
        <td><input name="jk" type="text" class="form-control"  value="<?php echo $data['jk'];?>" required/></td>
      </tr>
      <tr>
        <td><label for="tgl_lahir">Tanggal Lahir</label></td>
        <td><input name="tgl_lahir" type="date" class="form-control"  value="<?php echo $data['tgl_lahir'];?>" required/></td>
      </tr>
      <tr>
        <td><label for="alamat">Alamat Pasien</label></td>
        <td><input name="alamat" type="text" class="form-control"  value="<?php echo $data['alamat'];?>" required/></td>
      </tr>
...
?>
    ...
    <tr>
       <td><label for="id">Kode Pasien</label></td>
        <td><input name="id" type="text" class="form-control" value="" readonly="readonly"/></td>
      </tr>
      
      <tr>
        <td><label for="nama_pasien">Nama Pasien</label></td>
        <td><input name="nama_pasien" type="text" class="form-control"  value="" required/></td>
      </tr>
     <tr>
        <td><label for="jk">Jenis Kelamin</label></td>
        <td><input name="jk" type="text" class="form-control"  value="" required/></td>
      </tr>
      <tr>
        <td><label for="tgl_lahir">Tanggal Lahir</label></td>
        <td><input name="tgl_lahir" type="text " class="form-control"  value="" required/></td>
      </tr>
      <tr>
        <td><label for="alamat">Alamat Pasien</label></td>
        <td><input name="alamat" type="text" class="form-control"  value="" required/></td>
      </tr>
