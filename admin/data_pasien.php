...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Aplikasi SIMRS">
    <meta name="author" content="Hakko Bio Richard">

    <title>Selamat datang di sistem informasi rumah 
    sakit</title>
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SIMRS (Sistem informasi Rumah Sakit)</a>
        </div>
...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Halaman Utama <small>Admin SIMRS</small></h1>
            <ol class="breadcrumb">
            ...
            <div class="alert alert-success alert-dismissable">
             ...
             Selamat Datang Di Halaman Admin SIMRS.. 
          </div>
        </div><!-- /.row -->
<!--
        <div class="row">
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                 <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    if (mysql_num_rows($query) == 0) {
                        ...
                        echo'<td><a class="btn btn-sm btn-primary" href="edit.php?id='.$data['id'].'"><i class="fa fa-edit"></i> Edit</a>

                          <a class="btn btn-sm btn-danger" href="hapus.php?id='.$data['id'].'" onclick="return confirm(\'yakin?\')" ><i class="fa fa-wrench"></i> Hapus</a></td>';
                          echo "</tr>";
                ...
                <div class="text-right">
                  <a href="tambah.php" class="btn btn-sm btn-warning">Tambah Data <i class="fa fa-arrow-circle-right"></i></a>
